...
SEQ_LEN_TFT    = 1440   # 24 hours of 1-min candles — macro context
SEQ_LEN_BILSTM = 720    # 12 hours of 1-min candles — medium-term context

# ── Prediction horizons ───────────────────────────────────────────────────────
HORIZON_TFT    = 240    # 4 hours  — TFT predicts macro direction
HORIZON_BILSTM = 60     # 1 hour   — BiLSTM predicts medium-term momentum
HORIZON_META   = 60     # 1 hour   — Meta XGBoost actionable trading signal
...
MIN_HOLD_MIN    = 60      # minimum hold = one full meta prediction horizon
